...
foreign import ccall unsafe "yices_c.h yices_set_verbosity"
  c_set_verbosity :: CInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_version"
  c_version :: IO (Ptr (CChar))

--

foreign import ccall unsafe "yices_c.h yices_set_max_num_conflicts_in_maxsat_iteration"
  c_set_max_num_conflicts_in_maxsat_iteration :: CUInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_enable_type_checker"
  c_enable_type_checker :: CInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_set_max_num_iterations_in_maxsat"
  c_set_max_num_iterations_in_maxsat :: CUInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_set_maxsat_initial_cost"
  c_set_maxsat_initial_cost :: CLLong -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_set_arith_only"
  c_set_arith_only :: CInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_enable_log_file"
  c_enable_log_file :: Ptr (CChar) -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_mk_context"
  c_mk_context :: IO (Ptr YContext)

--

foreign import ccall unsafe "yices_c.h yices_del_context"
  c_del_context :: Ptr YContext -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_reset"
  c_reset :: Ptr YContext -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_dump_context"
  c_dump_context :: Ptr YContext -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_push"
  c_push :: Ptr YContext -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_pop"
  c_pop :: Ptr YContext -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_assert"
  c_assert :: Ptr YContext -> Ptr YExpr -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_assert_weighted"
  c_assert_weighted :: Ptr YContext -> Ptr YExpr -> CLLong -> IO AssertionId

--

foreign import ccall unsafe "yices_c.h yices_assert_retractable"
  c_assert_retractable :: Ptr YContext -> Ptr YExpr -> IO (CInt)

--

foreign import ccall unsafe "yices_c.h yices_retract"
  c_retract :: Ptr YContext -> CInt -> IO (())

--

foreign import ccall unsafe "yices_c.h yices_inconsistent"
  c_inconsistent :: Ptr YContext -> IO (CInt)

--

foreign import ccall unsafe "yices_c.h yices_check"
  c_check :: Ptr YContext -> IO (CInt)

--

foreign import ccall unsafe "yices_c.h yices_find_weighted_model"
...
foreign import ccall unsafe "yices_c.h yices_max_sat"
  c_max_sat :: Ptr YContext -> IO (CInt)

--

foreign import ccall unsafe "yices_c.h yices_max_sat_cost_leq"
  c_max_sat_cost_leq :: Ptr YContext -> CLLong -> IO (CInt)

--

foreign import ccall unsafe "yices_c.h yices_get_model"
  c_get_model :: Ptr YContext -> IO (Ptr YModel)

--

foreign import ccall unsafe "yices_c.h yices_get_unsat_core_size"
  c_get_unsat_core_size :: Ptr YContext -> IO (CUInt)

--

foreign import ccall unsafe "yices_c.h yices_get_unsat_core"
...
foreign import ccall unsafe "yices_c.h yices_get_int_value"
  c_get_int_value :: Ptr YModel -> Ptr YVarDecl -> Ptr (CLong) -> IO CInt

--

foreign import ccall unsafe "yices_c.h yices_get_arith_value"
  c_get_arith_value :: Ptr YModel -> Ptr YVarDecl -> Ptr (CLong) -> Ptr (CLong) -> IO CInt

--

foreign import ccall unsafe "yices_c.h yices_get_double_value"
  c_get_double_value :: Ptr YModel -> Ptr YVarDecl -> Ptr (CDouble) -> IO CInt

--

foreign import ccall unsafe "yices_c.h yices_get_bitvector_value"
...
foreign import ccall unsafe "yices_c.h yices_display_model"
...
foreign import ccall unsafe "yices_c.h yices_mk_true"
  c_mk_true :: Ptr YContext -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_false"
  c_mk_false :: Ptr YContext -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_bool_var"
  c_mk_bool_var :: Ptr YContext -> Ptr (CChar) -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_fresh_bool_var"
  c_mk_fresh_bool_var :: Ptr YContext -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_get_var_decl"
  c_get_var_decl :: Ptr YExpr -> IO (Ptr YVarDecl)

--

foreign import ccall unsafe "yices_c.h yices_mk_bool_var_decl"
  c_mk_bool_var_decl :: Ptr YContext -> Ptr CChar -> IO (Ptr YVarDecl)

--

foreign import ccall unsafe "yices_c.h yices_get_var_decl_name"
  c_get_var_decl_name :: Ptr YVarDecl -> IO (Ptr CChar)

--

foreign import ccall unsafe "yices_c.h yices_mk_bool_var_from_decl"
  c_mk_bool_var_from_decl :: Ptr YContext -> Ptr YDecl -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_or"
  c_mk_or :: Ptr YContext -> Ptr (Ptr YExpr) -> CUInt -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_and"
  c_mk_and :: Ptr YContext -> Ptr (Ptr YExpr) -> CUInt -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_eq"
  c_mk_eq :: Ptr YContext -> Ptr YExpr -> Ptr YExpr -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_diseq"
  c_mk_diseq :: Ptr YContext -> Ptr YExpr -> Ptr YExpr -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_ite"
  c_mk_ite :: Ptr YContext -> Ptr YExpr -> Ptr YExpr -> Ptr YExpr -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_mk_not"
  c_mk_not :: Ptr YContext -> Ptr YExpr -> IO (Ptr YExpr)

--

foreign import ccall unsafe "yices_c.h yices_create_var_decl_iterator"
  c_create_var_decl_iterator :: Ptr YContext -> IO (Ptr YVarIterator)

--

foreign import ccall unsafe "yices_c.h yices_iterator_has_next"
  c_iterator_has_next :: Ptr YVarIterator -> IO CInt

--

foreign import ccall unsafe "yices_c.h yices_iterator_next"
